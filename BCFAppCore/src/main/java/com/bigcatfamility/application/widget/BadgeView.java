...
public class BadgeView extends TextView {
	...
	public BadgeView(Context context, AttributeSet attrs, int defStyle,
		...
		int badgeColor = a.getColor(R.styleable.BadgeView_badgeBackgroundColor,
				DEFAULT_BADGE_COLOR);
		a.recycle();

		init(context, target, tabIndex, badgeColor);
	}

	private void init(Context context, View target, int tabIndex, int badgeColor) {
